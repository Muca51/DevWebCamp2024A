<fieldset class="formulario__fieldset">
    ...
    <legend class="formulario__legend">Información de Personal</legend>
    ...
    <div class="formulario__campo">
        ...
        <input 
            ...
            id="apellido"
            name="apellido"
            placeholder="Apellido Completo del Ponente"
    ...
    <div class="formulario__campo">
        ...
        <input 
            ...
            id="ciudad"
            name="ciudad"
            placeholder="Ciudad Origen del Ponente"
    ...
    <div class="formulario__campo">
        ...
        <input 
            ...
            id="pais"
            name="pais"
            placeholder="País de Origen del Ponente"
