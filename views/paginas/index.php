        ...
        <?php foreach($ponentes as $ponente) { ?>
            <div <?php aos_animacion(); ?> class="speaker">
                ...
                <picture>
                    ...
                    <img class="speakers__imagen" loading="lazy" width="200" height="300" src="img/speakers/<?php echo $ponente->imagen; ?>.png" alt="Imagen Ponente">
...
<section class="boletos">
    ...
    <div class="boletos__grid">
        ...
        <div <?php aos_animacion(); ?> class="boleto boleto--presencial">
            ...
            <p class="boleto__precio">$199 USD</p>                                                                     
        </div>

        <div <?php aos_animacion(); ?> class="boleto boleto--virtual">
            <h4 class="boleto__logo">&#60;DevWebCamp /></h4>
            <p class="boleto__plan">Virtual</p>                                   
            <p class="boleto__precio">$49 USD</p>                                                                     
        </div>
